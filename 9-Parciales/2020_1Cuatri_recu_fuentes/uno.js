...
function mostrar()
{
	...
	while( contador < 5){ 
		...
		//a)
		if (tipoProducto == "jabon" && bandera== 0) { //condicion == true 
			cantidadMasCaro = cantidadDeUnidades;
			fabricanteMasCaro = fabricante;
			bandera == 1;
		}else if(tipoProducto == "jabon" && precio > precioMasCaro){
	...
	mensaje = mensaje+`\n hay ${cantidadTotalDeBarbijo} unidades de barbijos en total`;
